		...
		try {
			...
			while (!eof) {
				...
				if (line == null) {
					...
					int quizCounter1 = 0;
					int quizCounter2 = 0;
					int[] scoresSub1 = new int[5];
					int[] scoresSub2 = new int[5];
				    ...
				    while (st.hasMoreTokens()) {
				    	if(firstValueOfLine) {
				    		...
				    		if(quizCounter1<5)
				    		{
				    			scoresSub1[quizCounter1] = Integer.parseInt(st.nextToken());
					    		quizCounter1++;
				    		}
				    		else 
				    		{
				    			scoresSub2[quizCounter2] = Integer.parseInt(st.nextToken());
					    		quizCounter2++;
				    		}
				    ...
				    s.setScores("chemistry" , scoresSub1);
				    s.setScores("computer science" , scoresSub2);
