...
java -cp src lab2.Driver

On execution the program will read the file, create the student objects, compute class stats and then serialize the student objects to individual files. 